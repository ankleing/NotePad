...
```
   + 修改前后的虚拟键盘  
   ![图片](https://github.com/ankleing/NotePad/blob/main/image/image6.png)  
   ![图片](https://github.com/ankleing/NotePad/blob/main/image/image5.png)  
...
<shape xmlns:android="http://schemas.android.com/apk/res/android">
   ...
   ```
![图片](https://github.com/ankleing/NotePad/blob/main/image/image1.png)
   ### 2 根据时间切换深色背景
   在夜晚切换深色背景减缓人眼疲劳
  + 主页面切换深色背景
```java
 ...
 ```
![图片](https://github.com/ankleing/NotePad/blob/main/image/image3.png)
  + 编辑界面切换深色背景
```java
...
```   
   ![图片](https://github.com/ankleing/NotePad/blob/main/image/image4.png)
   ### 3 美化UI
   + 使卡片变得透明以及增加圆角
```java
   <shape xmlns:android="http://schemas.android.com/apk/res/android">
...
<EditText
    ...
    <EditText
        ...
        tools:ignore="MissingConstraints" />
```        
  ![图片](https://github.com/ankleing/NotePad/blob/main/image/image2.png)
